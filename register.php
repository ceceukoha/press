        ...
        <div class="container mt-5">
            ...
            <div class="card mx-auto shadow" style="max-width: 600px">
                <div class="card-body">
                    ...
                    <!-- link the form to reg_control -->
                 <form action="assets/app/reg_control" method="post" class="row"> 
                    <div class="col-md-6 mb-2">
                        <label>Full Name: </label>
                        <input type="text" name="fname" class="form-control rounded-0 shadow-sm">
                    </div>
                    <div class="col-md-6 mb-2">
                        <label>Email: </label>
                    ...
                    <div class="col-md-6 mb-2">
                        <label>Phone: </label>
                        <input type="tel" name="phone" class="form-control rounded-0 shadow-sm">
                    </div>
                    <div class="col-md-6 mb-2">
                        <label>Gender: </label>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="dob" onfocus="this.type='date'" class="form-control rounded-0 shadow-sm">
                    </div>
                    ...
                    <div class="text-center my-3">
                        <button type="submit" name="register" class="btn btn-primary rounded-0 px-5 py-2">Register</button>
                    </div>
                 </form>
                </div>
            </div>
